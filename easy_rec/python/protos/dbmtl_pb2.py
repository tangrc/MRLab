...
_DBMTL.fields_by_name['bottom_cmbf'].message_type = easy__rec_dot_python_dot_protos_dot_layer__pb2._CMBFTOWER
_DBMTL.fields_by_name['bottom_uniter'].message_type = easy__rec_dot_python_dot_protos_dot_layer__pb2._UNITERTOWER
