...
_OPTIMIZER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_moving_average', full_name='protos.Optimizer.use_moving_average', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='moving_average_decay', full_name='protos.Optimizer.moving_average_decay', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='embedding_learning_rate_multiplier', full_name='protos.Optimizer.embedding_learning_rate_multiplier', index=11,
